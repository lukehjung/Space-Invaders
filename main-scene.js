...
//             context.register_scene_component(new Movement_Controls(context, control_box.parentElement.insertCell()));
    ...
    {
//        while(this.shoot_matrix[1][3] < 25)
    }
    ...
    create_boundaries(graphics_state)
    {
        ...
        graphics_state,
        m.times(Mat4.translation(Vec.of(-15, 0 ,0 ))).times(Mat4.scale(Vec.of(1,50,1))),
    ...
    display(graphics_state) {
        ...
        this.shapes.ball.draw(
                ...
                this.ship_matrix,
                this.shape_materials[1] || this.plastic);
        console.log(this.shoot_matrix[1][3]);
        this.shapes.ball.draw(
                graphics_state,
                this.shoot_matrix.times(Mat4.scale(Vec.of(.5,.5,.5))),
                this.shape_materials[1] || this.plastic);              
    }
}
